...
case "$(uname -s)" in
    ...
    # for this script, twe treat FreeBSD the same as linux
    FreeBSD*) platform=linux;;
    Darwin*) platform=macos;;
    # Misc. Windows bash-likes, e.g. on Github Actions, Git Bash, etc.
...
if [[ "$platform" == "windows" ]] || [[ 10#$vernum -le 10#000002013 ]]; then
    ext="zip"
